...
export const zodSchemaEvent = z.object({
  ...
  cancel_time_in_hours: z.any().optional(),
...
export const zodSchemaPackage = z.object({

  package_id: z.any().optional(),
  user_id: z.any().optional(),
  package_type: z.any().refine(val => val !== undefined && val !== null && val !== '', {
    message: "Package Type is required"
  }),
  quantity_available: z.any().refine(val => val !== undefined && val !== null && val !== '', {
    message: "Quantity is required"
  }),
  price: z.any().refine(val => val !== undefined && val !== null && val !== '', {
