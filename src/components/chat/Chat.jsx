...
import { Dot, Plus, Send, Mic, Camera, Smile, Search, Heart, Bell, X } from "lucide-react";
import { Avatar, Button, Input } from "@material-tailwind/react";
import SendBird from 'sendbird';

// Initialize SendBird
const sb = new SendBird({ appId: '5A242DB3-0E5A-49D3-8B84-0DF9497CE169' });
  ...
  const handleSendMessage = async (e) => {
    ...
    if (selectedImage && sbChannel) {
      ...
      sbChannel.sendFileMessage(params, (message, error) => {
        ...
        const fileUrl = message.url.startsWith('http') 
          ? message.url 
          : `https://file-ap-8.sendbird.com${message.url}`;
