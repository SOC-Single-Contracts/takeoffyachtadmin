...
import { getBoatById, updateBoat } from '../../services/api/boatService';
...
const EditNewYearBoat = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      await updateBoat(id, formData, features);
  ...
  return (
    <div className="p-6">
      <Card className="p-6">
        <h1 className="text-3xl font-bold mb-6 font-sora">Edit New Year Boat</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Update Yacht Image</label>
              <input 
                type="file" 
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Update Dark Image</label>
              <input 
                type="file" 
                {...register('darkimage')} 
                className="block w-full text-sm text-gray-500
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Update Light Image</label>
              <input 
                type="file" 
                {...register('lightimage')} 
                className="block w-full text-sm text-gray-500
...
export default EditNewYearBoat;
